<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="/admin/dashboard">
      ...
      <span class="ms-1 font-weight-bold">MFT Surgical</span>
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse  w-auto h-auto max-height-vh-100 h-100" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a data-bs-toggle="collapse" href="#categories" class="nav-link " aria-controls="categories" role="button" aria-expanded="false">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>office</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <div class="collapse " id="categories">
          <ul class="nav ms-4 ps-3">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/admin/add/categories">
                <span class="sidenav-mini-icon"> Add </span>
                <span class="sidenav-normal"> Add Categories </span>
              </a>
            </li>
          </ul>
        </div>
      ...
      <li class="nav-item">
        <a href="/admin/contact/enquiries" class="nav-link">
          ...
          <span class="nav-link-text ms-1">Contact Enquiries</span>
        </a>
      </li>
      <li class="nav-item">
        <a href="/admin/product/enquiries" class="nav-link">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>office</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <span class="nav-link-text ms-1">Product Enquiries</span>
        </a>
      </li>
      <li class="nav-item">
